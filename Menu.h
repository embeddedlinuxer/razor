...
_EXTERN char USB_ERROR7[]						= "    USB BAD NAME"; /// The given string is invalid as the path name.
_EXTERN char USB_ERROR8[]						= "      USB DENIED"; /// The required access was denied due to one of the following reasons: 
_EXTERN char USB_ERROR9[]						= "  USB BAD OBJECT"; /// The file/directory object is invalid or a null pointer is given.
_EXTERN char USB_ERROR10[]						= "USB WR PROTECTED"; /// A write mode operation against the write-protected media.
_EXTERN char USB_ERROR11[]						= "   USB BAD DRIVE"; /// Invalid drive number is specified in the path name or a null pointer is given as the path name.
_EXTERN char USB_ERROR12[]						= " USB NOT ENABLED"; /// Work area for the logical drive has not been registered by f_mount function.
_EXTERN char USB_ERROR13[]						= "      USB BAD FS"; /// There is no valid FAT volume on the drive or wrong lower layer implementation.
